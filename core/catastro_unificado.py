...
def catastro_unificado(textEdit, df_r1r2, gdf_baseCPOT, output):
    """
    ...
    print(" - 3.3 exportando resultado a excel")
    ...
    # exportando resultado a excel
    print(" - 3.4 exportando resultado a excel depues de eliminar duplicados")
